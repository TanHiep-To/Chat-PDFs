...
const Pricing = async () => {
  ...
  const pricingItems = [
    {
      ...
      features: [
        ...
        {
          text: "Explain text right from the PDF",
          // negative: true,
        },
        {
  ...
  const handleClick = () => {
    alert("This feature is not ready for production as it is in review.");
  };
  ...
  return (
    <>
      ...
      <WrapWidth className="mx-auto mb-8 mt-1 max-w-5xl text-center">
